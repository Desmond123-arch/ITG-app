...
const CompanyCard: React.FC<Props> = ({company}) => {
  return (
    <Link to={`/company/${company.id}`} className='group rounded-md bg-white shadow-sm p-3 flex flex-col gap-4 w-full md:w-[260px] min-h-[170px] md:max-w-[285px] hover:shadow-lg transition-all justify-between'>
