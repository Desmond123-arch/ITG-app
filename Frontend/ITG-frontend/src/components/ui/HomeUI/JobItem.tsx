...
const JobItem: React.FC<Props> = ({job}) => {
  return (
    <Link to={`/job/${job.id}`} className='group rounded-md bg-white shadow-sm p-3 flex flex-col gap-4 min-h-[190px] md:w-[280px] w-full hover:shadow-lg transition-all justify-between'>
