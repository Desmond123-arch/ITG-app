...
export const JobSeekerForms = () => {
    const formSchema = z.object({
        ...
        phone: z.string().regex(/^\+?[0-9]{10}$/, "Invalid phone number. Must be 10 digits and can start with +"),
        address: z.string(),
        roleid: z.string(),
    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-2 py-4">
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem className="px-4">
                            ...
                            <FormControl>
                                <Input {...field} className="w-[90%] mx-auto !text-lg py-4" />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem className="px-4">
                            ...
                            <FormControl>
                                <Input {...field} className="w-[90%] mx-auto !text-lg py-4" placeholder="" />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem className="px-4">
                            <FormLabel className="text-md">Disability</FormLabel>
                            <FormControl>
                                <Input {...field} className="w-[90%] mx-auto !text-lg py-4" placeholder="" />
                            </FormControl>
                            <FormMessage />
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem className="px-4">
                            <FormLabel className="text-md">Preferred Location</FormLabel>
                            <FormControl>
                                <Input {...field} className="w-[90%] mx-auto !text-lg py-4" placeholder="" />
                            </FormControl>
                            <FormMessage />
                ...
                <FormField
                    ...
                    render={({ field: { value, onChange, ...fieldProps } }) => (
                        <FormItem className="p-6 border rounded-lg shadow-sm">
                            <FormLabel className="text-lg font-medium mb-2 block">Resume</FormLabel>
                            <FormControl>
            ...
            <FormItem className="p-4 border border-dashed rounded-md">
              ...
              <FormControl>
                <div className="relative w-full h-32 flex flex-col items-center justify-center">
                  <div
                    className={`relative w-full h-full border-2 border-dashed rounded-lg flex flex-col items-center justify-center gap-2 transition-all ${
                      isLogoUploaded ? "bg-primary/10 border-primary" : "hover:bg-muted/50 border-muted-foreground/25"
                    }`}
                  >
                    {isLogoUploaded ? (
                      <>
